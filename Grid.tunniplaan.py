...
keel=Button(text="Keel ja kirjandus",bg="#32F224",borderwidth=1,relief="solid").grid(row=1,rowspan=2,column=9,columnspan=2,sticky=W+E+N+S)
...
tugkeem=Button(text="Tugiõpe Keemia",borderwidth=1,relief="solid",bg="#C929CB").grid(row=3,rowspan=2,column=3,sticky=W+E+N+S)
...
esttug1=Button(text="Tugiõpe Eesti keel \n 2 grupp",borderwidth=1,relief="solid",bg="#F335F6").grid(row=5,column=3,sticky=W+E+N+S)
kunst=Button(text="Kunstiained",borderwidth=1,relief="solid",bg="#C929CB").grid(row=5,rowspan=2,column=4,columnspan=2,sticky=W+E+N+S)
Label(text=" Перерыв ",borderwidth=1,relief="solid").grid(row=5,rowspan=2,column=6,sticky=W+E+N+S)
kehalinekasv=Button(text="Kehaline Kasvatus",borderwidth=1,relief="solid",bg="#C929CB").grid(row=5,rowspan=2,column=7,columnspan=2,sticky=W+E+N+S)
